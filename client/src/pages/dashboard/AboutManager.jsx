      ...
      {activeTab === 'info' && (
        <Card className="p-6">
          <div className="mb-6">
            ...
            <p className="text-sm text-slate-600 mt-1">Ubah informasi tentang Inspira Innovation yang ditampilkan di halaman Tentang Kami</p>
          </div>
          ...
          <form onSubmit={saveAboutText} className="space-y-4">
            <div>
              ...
              <Input
                ...
                placeholder="Tentang Inspira Innovation"
              />
            </div>
