...
export function Button({ variant = 'primary', className, ...props }) {
  const base =
    'inline-flex items-center justify-center px-4 py-2 text-sm font-semibold rounded-lg transition-all hover:scale-105 focus:outline-none disabled:opacity-50 disabled:pointer-events-none';
